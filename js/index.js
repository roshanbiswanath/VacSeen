        ...
        if (typeof centLocList != "undefined") {
            geoFeature = {
                ...
                "geometry": {
                    "type": "Point",
                    "coordinates":
                        [centerDict[session["center_id"]][1], centerDict[session["center_id"]][0]]
                }
            }
